...
<body>
    ...
    //$sql = "SELECT PicureID, ProductName, ProductDescriptions FROM products where CategoryID = 2 ORDER BY ProductID DESC";
    $sql = "call GetProductCat2()";
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Cell, Phone and Accessories</li>
                </ol>
            </div>
        </div>
