...
<body>
    ...
    //$sql = "SELECT PicureID, ProductName, ProductDescriptions FROM products where CategoryID = 6 ORDER BY ProductID DESC";
    $sql = "call GetProductCat6()";
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Home and Garden</li>
                </ol>
            </div>
        </div>
