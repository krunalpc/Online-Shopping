...
<body>
    ...
    //$sql = "SELECT PicureID, ProductName, ProductDescriptions FROM products where CategoryID = 1 ORDER BY ProductID DESC";
    $sql = "call GetProductCat1()";
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Business Industrial</li>
                </ol>
            </div>
        </div>
